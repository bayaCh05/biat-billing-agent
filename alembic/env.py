...
# Make the project root importable so ORM models can be imported
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

# Import all ORM modules so their tables are registered on Base.metadata
from src.storage.db import Base                       # noqa: E402
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode — connect to the DB and apply migrations."""
